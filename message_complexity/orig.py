# -*- generated by 1.0.12 -*-
import da
PatternExpr_690 = da.pat.TuplePattern([da.pat.ConstantPattern('CAPTURE'), da.pat.FreePattern('ph'), da.pat.FreePattern('l'), da.pat.FreePattern('node')])
PatternExpr_701 = da.pat.FreePattern('sender')
PatternExpr_903 = da.pat.TuplePattern([da.pat.ConstantPattern('ACCEPT'), da.pat.FreePattern('ph'), da.pat.FreePattern('l')])
PatternExpr_912 = da.pat.FreePattern('sender')
PatternExpr_983 = da.pat.TuplePattern([da.pat.ConstantPattern('ACK'), da.pat.FreePattern('node')])
PatternExpr_990 = da.pat.FreePattern('sender')
PatternExpr_1024 = da.pat.TuplePattern([da.pat.ConstantPattern('ELECTED'), da.pat.FreePattern('node')])
PatternExpr_1031 = da.pat.FreePattern('sender')
PatternExpr_1059 = da.pat.TuplePattern([da.pat.ConstantPattern('INFORM'), da.pat.FreePattern('x')])
PatternExpr_1066 = da.pat.FreePattern('sender')
PatternExpr_1110 = da.pat.TuplePattern([da.pat.ConstantPattern('OWNER'), da.pat.FreePattern('node')])
PatternExpr_1117 = da.pat.FreePattern('sender')
_config_object = {}
import sys
import math
import random
...
class P(da.DistProcess):
    ...
    def __init__(self, procimpl, props):
        ...
        self._events.extend([da.pat.EventPattern(da.pat.ReceivedEvent, '_PReceivedEvent_0', PatternExpr_690, sources=[PatternExpr_701], destinations=None, timestamps=None, record_history=None, handlers=[self._P_handler_689]), da.pat.EventPattern(da.pat.ReceivedEvent, '_PReceivedEvent_1', PatternExpr_903, sources=[PatternExpr_912], destinations=None, timestamps=None, record_history=None, handlers=[self._P_handler_902]), da.pat.EventPattern(da.pat.ReceivedEvent, '_PReceivedEvent_2', PatternExpr_983, sources=[PatternExpr_990], destinations=None, timestamps=None, record_history=None, handlers=[self._P_handler_982]), da.pat.EventPattern(da.pat.ReceivedEvent, '_PReceivedEvent_3', PatternExpr_1024, sources=[PatternExpr_1031], destinations=None, timestamps=None, record_history=None, handlers=[self._P_handler_1023]), da.pat.EventPattern(da.pat.ReceivedEvent, '_PReceivedEvent_4', PatternExpr_1059, sources=[PatternExpr_1066], destinations=None, timestamps=None, record_history=None, handlers=[self._P_handler_1058]), da.pat.EventPattern(da.pat.ReceivedEvent, '_PReceivedEvent_5', PatternExpr_1110, sources=[PatternExpr_1117], destinations=None, timestamps=None, record_history=None, handlers=[self._P_handler_1109])])

    def setup(self, hCycle, **rest_1274):
        super().setup(hCycle=hCycle, **rest_1274)
    ...
    def _P_handler_689(self, ph, l, node, sender):
        ...
        if (self._state.state == 'candidate'):
            ...
            if (ph == 1):
                ...
                if ((self._state.phase == 1) or (self._state.owner == 0)):
                    ...
                    self._state.nMsg = (self._state.nMsg + 1)
    _P_handler_689._labels = None
    _P_handler_689._notlabels = None

    def _P_handler_902(self, ph, l, sender):
        self._state.receiving_flag = True
        if (self._state.state == 'candidate'):
            if ((self._state.phase == 1) and (ph == 1)):
                ...
                if (self._state.Response >= len(self._state.ringPh2)):
                    ...
                    if (self._state.step >= (math.log(self._state.k, 2) + 1)):
                        ...
                        self._state.Received = True
    _P_handler_902._labels = None
    _P_handler_902._notlabels = None

    def _P_handler_982(self, node, sender):
        self._state.receiving_flag = True
        if ((self._state.state == 'candidate') and (self._state.phase == 1) and (node == self._id)):
            self._state.Response = (self._state.Response + 1)
            if (self._state.Response >= (len(self._state.ring) - 1)):
                self._state.phase = 2
    _P_handler_982._labels = None
    _P_handler_982._notlabels = None

    def _P_handler_1023(self, node, sender):
        self._state.receiving_flag = True
        if (self._state.state == 'candidate'):
            self._state.state = 'captured'
    ...
    def _P_handler_1058(self, x, sender):
        self._state.receiving_flag = True
        if ((self._state.state == 'candidate') and (self._state.phase == 2)):
            ...
            self._state.nMsg = (self._state.nMsg + 1)
    _P_handler_1058._labels = None
    _P_handler_1058._notlabels = None

    def _P_handler_1109(self, node, sender):
        self._state.receiving_flag = True
        if ((self._state.state == 'captured') and (self._state.phase == 1)):
            ...
            self.send(('ACK', node), to=sender)
            self._state.nMsg = (self._state.nMsg + 1)
    _P_handler_1109._labels = None
    _P_handler_1109._notlabels = None
