# -*- generated by 1.0.12 -*-
import da
PatternExpr_647 = da.pat.TuplePattern([da.pat.ConstantPattern('CAPTURE'), da.pat.FreePattern('ph'), da.pat.FreePattern('l'), da.pat.FreePattern('node')])
PatternExpr_658 = da.pat.FreePattern('sender')
PatternExpr_820 = da.pat.TuplePattern([da.pat.ConstantPattern('ACCEPT'), da.pat.FreePattern('ph'), da.pat.FreePattern('l')])
PatternExpr_829 = da.pat.FreePattern('sender')
PatternExpr_900 = da.pat.TuplePattern([da.pat.ConstantPattern('ACK'), da.pat.FreePattern('node')])
PatternExpr_907 = da.pat.FreePattern('sender')
PatternExpr_941 = da.pat.TuplePattern([da.pat.ConstantPattern('ELECTED'), da.pat.FreePattern('node')])
PatternExpr_948 = da.pat.FreePattern('sender')
PatternExpr_976 = da.pat.TuplePattern([da.pat.ConstantPattern('INFORM'), da.pat.FreePattern('x')])
PatternExpr_983 = da.pat.FreePattern('sender')
PatternExpr_1022 = da.pat.TuplePattern([da.pat.ConstantPattern('OWNER'), da.pat.FreePattern('node')])
PatternExpr_1029 = da.pat.FreePattern('sender')
_config_object = {}
import sys
import math
import random
...
class P(da.DistProcess):
    ...
    def __init__(self, procimpl, props):
        ...
        self._events.extend([da.pat.EventPattern(da.pat.ReceivedEvent, '_PReceivedEvent_0', PatternExpr_647, sources=[PatternExpr_658], destinations=None, timestamps=None, record_history=None, handlers=[self._P_handler_646]), da.pat.EventPattern(da.pat.ReceivedEvent, '_PReceivedEvent_1', PatternExpr_820, sources=[PatternExpr_829], destinations=None, timestamps=None, record_history=None, handlers=[self._P_handler_819]), da.pat.EventPattern(da.pat.ReceivedEvent, '_PReceivedEvent_2', PatternExpr_900, sources=[PatternExpr_907], destinations=None, timestamps=None, record_history=None, handlers=[self._P_handler_899]), da.pat.EventPattern(da.pat.ReceivedEvent, '_PReceivedEvent_3', PatternExpr_941, sources=[PatternExpr_948], destinations=None, timestamps=None, record_history=None, handlers=[self._P_handler_940]), da.pat.EventPattern(da.pat.ReceivedEvent, '_PReceivedEvent_4', PatternExpr_976, sources=[PatternExpr_983], destinations=None, timestamps=None, record_history=None, handlers=[self._P_handler_975]), da.pat.EventPattern(da.pat.ReceivedEvent, '_PReceivedEvent_5', PatternExpr_1022, sources=[PatternExpr_1029], destinations=None, timestamps=None, record_history=None, handlers=[self._P_handler_1021])])

    def setup(self, hCycle, **rest_1187):
        super().setup(hCycle=hCycle, **rest_1187)
    ...
    def candidateAct(self):
        while ((self._state.state == 'candidate') and (self._state.phase == 1)):
            ...
            while ((self._state.state == 'candidate') and (self._state.phase == 1) and (self._state.Received == False)):
                super()._label('_st_label_426', block=False)
                _st_label_426 = 0
                while (_st_label_426 == 0):
                    _st_label_426 += 1
                    if self._state.receiving_flag:
                        _st_label_426 += 1
                    else:
                        super()._label('_st_label_426', block=True)
                        _st_label_426 -= 1
                else:
                    if (_st_label_426 != 2):
                        continue
    ...
    def capturedAct(self):
        ...
        while (self._state.done == False):
            if (self._state.first_msg == True):
                ...
                self._state.owner = 0
                self._state.phase = 1
            super()._label('_st_label_636', block=False)
            _st_label_636 = 0
            while (_st_label_636 == 0):
                _st_label_636 += 1
                if self._state.receiving_flag:
                    _st_label_636 += 1
                else:
                    super()._label('_st_label_636', block=True)
                    _st_label_636 -= 1
            else:
                if (_st_label_636 != 2):
                    continue
    ...
    def _P_handler_646(self, ph, l, node, sender):
    ...
    _P_handler_646._labels = None
    _P_handler_646._notlabels = None

    def _P_handler_819(self, ph, l, sender):
        self._state.receiving_flag = True
        if (self._state.state == 'candidate'):
            if ((self._state.phase == 1) and (ph == 1)):
                ...
                if (self._state.Response >= len(self._state.ringPh2)):
                    ...
                    if (self._state.step >= (math.log(self._state.k, 2) + 1)):
                        ...
                        self._state.Received = True
    _P_handler_819._labels = None
    _P_handler_819._notlabels = None

    def _P_handler_899(self, node, sender):
        self._state.receiving_flag = True
        if ((self._state.state == 'candidate') and (self._state.phase == 1) and (node == self._id)):
            self._state.Response = (self._state.Response + 1)
            if (self._state.Response >= (len(self._state.ring) - 1)):
                self._state.phase = 2
    _P_handler_899._labels = None
    _P_handler_899._notlabels = None

    def _P_handler_940(self, node, sender):
        self._state.receiving_flag = True
        if (self._state.state == 'candidate'):
            self._state.state = 'captured'
            ...
            self._state.leaderid = node
    _P_handler_940._labels = None
    _P_handler_940._notlabels = None

    def _P_handler_975(self, x, sender):
        self._state.receiving_flag = True
        if ((self._state.state == 'candidate') and (self._state.phase == 2)):
    ...
    _P_handler_975._labels = None
    _P_handler_975._notlabels = None

    def _P_handler_1021(self, node, sender):
        self._state.receiving_flag = True
        if ((self._state.state == 'captured') and (self._state.phase == 1)):
            ...
            self._state.owner = self._state.hCycle.index(node)
            self.send(('ACK', node), to=sender)
    _P_handler_1021._labels = None
    _P_handler_1021._notlabels = None
